...
<body class="antialiased">
    <header id="home" class="sticky top-0 z-50 bg-white/80 backdrop-blur-lg shadow-sm">
        <nav class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <a href="#api-keys" class="hidden md:block bg-accent text-white px-4 py-2 rounded-full font-semibold bg-accent-hover transition-colors">Get API Keys</a>

                <div class="md:hidden">
                    <button id="mobile-menu-button" class="text-gray-800 hover:text-amber-600 focus:outline-none" aria-controls="mobile-menu" aria-expanded="false">
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4">
                <a href="#features" class="block py-2 px-4 text-gray-600 hover:bg-gray-100 rounded">Features</a>
                <a href="#gemini" class="block py-2 px-4 text-gray-600 hover:bg-gray-100 rounded">Why Gemini?</a>
                <a href="#faq" class="block py-2 px-4 text-gray-600 hover:bg-gray-100 rounded">FAQ</a>
                <a href="#api-keys" class="block py-2 px-4 mt-2 text-amber-600 font-semibold hover:bg-gray-100 rounded">Get API Keys</a>
            </div>
        </nav>
    </header>
    ...
    <main class="container mx-auto px-6 py-12 md:py-20">
        ...
        <section id="features" class="mt-20 md:mt-28">
            ...
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card p-6"><h3 class="text-xl font-semibold text-gray-800 mb-3">🖼️ Image Editing Studio</h3><p class="text-gray-600">Upload one or more images, describe your edits, add text, and generate a new composite image.</p></div>
                <div class="card p-6"><h3 class="text-xl font-semibold text-gray-800 mb-3">🎶 Worship Song Studio</h3><p class="text-gray-600">Write lyrics and create a musical concept for a new worship song.</p></div>
    ...
    <footer class="mt-20 md:mt-28 border-t">
        <div class="container mx-auto px-6 py-8 text-center text-gray-500">
            <p>&copy; 2025 AI Ministry & Content Suite. A tool for creativity and learning.</p>
        </div>
    </footer>
    ...
    """
    components.html(html_content, height=1200,width=1200, scrolling=True)