...
st.markdown(
    ...
    "click **Stop Recording**. The captured audio will appear below."
)
st.markdown("---")
...
# --- CONTROL BUTTONS ---
st.subheader("2. Control Recording")
...
if stop_button:
    ...
    if st.session_state.audio_frames:
        with st.spinner("Saving audio..."):
            ...
            try:
                audio_data = struct.pack('h' * len(st.session_state.audio_frames), *st.session_state.audio_frames)
...
if st.session_state.audio_file_path:
    st.subheader("3. Play Your Recording")
